...
class TemperatureReplicaExchange(ReplicaExchange):
    ...
    def __init__(self, system, temperature_Range:Iterable=np.linspace(start=298, stop=320, num=3), exchange_criterium=None, steps_between_trials=20,
...
class ReplicaExchangeEnvelopingDistributionSampling(ReplicaExchange):
    ...
    def __init__(self, system, s_range:Iterable=np.logspace(start=1, stop=-4, num=3), exchange_criterium=None, steps_between_trials=20,
                 exchange_trajs:bool=False):
