...
def simulation_analysis_plot(
    ...
    if system.nDimensions == 1:
        if hasattr(system, "bias_potential") and system.bias_potential:
            fig = oneD_biased_simulation_analysis_plot(
                system=system,
                title=title,
                out_path=out_path,
            ...
            fig = oneD_simulation_analysis_plot(
                system=system,
                title=title,
                out_path=out_path,
                limits_coordinate_space=limits_coordinate_space,
        ...
        fig = twoD_simulation_analysis_plot(
            system=system,
            title=title,
            out_path=out_path,
            limits_coordinate_space=limits_coordinate_space,
...
def twoD_simulation_analysis_plot(
    ...
    if issubclass(system.sampler.__class__, newtonian.newtonianSampler) or issubclass(
        system.sampler.__class__, optimizers.optimizer
    ):
