...
class test_System1D(unittest.TestCase):
    def test_system_constructor(self):
        ...
        sys = system.basic_system.system(potential=pot, integrator=integ, position=position, temperature=temperature)
    ...
    def test_append_state(self):
        ...
        sys = system.basic_system.system(potential=pot, integrator=integ, conditions=[], temperature=temperature, position=position)
