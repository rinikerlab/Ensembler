...
project = "Ensembler"
copyright = (
    "2020, Benjamin Ries, Stephanie Linker, David Hahn. Project structure based on the "
...
exclude_patterns = ["_build", "Thumbs.db", ".DS_Store", "ensembler/test"]
...
latex_documents = [
    (master_doc, "ensembler.tex", "Ensembler Documentation", "ensembler", "manual"),
]
...
man_pages = [(master_doc, "ensembler", "Ensembler Documentation", [author], 1)]
