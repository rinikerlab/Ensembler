...
latex_documents = [
    (master_doc, 'ensembler.tex', 'Ensembler Documentation',
     'ensembler', 'manual'),
]
...
man_pages = [
    (master_doc, 'ensembler', 'Ensembler Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ensembler', 'Ensembler Documentation',
     author, 'ensembler', 'Code to sample ensembles of simple (toy) models with various algorithms. ',
     'Miscellaneous'),
]
